...
if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST['place_order'])) {
    ...
    $customerName = $_POST['customer_name']; // Get customer name
    ...
    if ($orderType === 'delivery' && empty(trim($address))) {
        ...
        $order = new Order();
        $orderId = $order->createOrder($userId, $_SESSION['user_email'], $customerName, $cartItems, $finalTotal, $paymentMethod, $address, $orderType, $pickupTime); 
        ...
        <section class="checkout bg-white p-8 rounded-lg shadow-md">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                <div class="order-summary">
                    ...
                    <table class="w-full table-auto">
                        ...
                        <tbody>
                            <?php foreach ($cartItems as $item): ?>
                                <tr class="border-b border-gray-200 font-bembo">
                                    <td class="py-2 px-4"><?= htmlspecialchars($item['name']); ?></td>
                                    <td class="py-2 px-4">₱<?= htmlspecialchars($item['price']); ?></td> 
                    ...
                    <p class="text-lg font-bold mt-4">Total: ₱<span id="total-price"><?= number_format($finalTotal, 2); ?></span></p> 
                </div> 
                ...
                <div class="shipping-details">
                    ...
                    <div>
                        <label for="customer_name" class="block text-gray-700 font-bold">Customer Name:</label>
