...
if (isset($_GET['order_id'])) {
    ...
    $sql = "SELECT o.*, 
            ...
            WHERE o.id = ?"; // Removed GROUP BY clause
...
<body class="bg-gray-100 text-gray-800 font-bembo">
    ...
    <main class="container mx-auto px-4 py-8">
        <section class="confirmation bg-white p-8 rounded-lg shadow-md" id="printable">
            ...
            <div class="order-details mt-8"> 
                ...
                <p class="mb-2"><span class="font-bold">Customer Name:</span> <?php echo htmlspecialchars($orderDetails[0]['customer_name']); ?></p> <!-- Added Customer Name -->
                    ...
                    <tbody>
                        <?php foreach ($orderDetails as $item): ?>
                            <tr class="border-b border-gray-200">
                                ...
                                <td class="py-2 px-4"><?php echo htmlspecialchars($item['item_quantity']); ?></td>
                                <td class="py-2 px-4">P<?php echo htmlspecialchars($item['product_price']); ?></td>
            ...
            <button onclick="window.print()" class="bg-primary text-white font-bold py-2 px-4 rounded hover:bg-green-600 transition-colors mt-8 inline-block">Print Receipt</button>
        </section>
    </main>
