...
<body class="bg-gray-100 text-gray-800 font-bembo">
    ...
    <main class="container mx-auto px-4 py-8">
        <section class="manage-products bg-white p-8 rounded-lg shadow-md">
            ...
            <a href="add_product.php" class="bg-green-500 text-white font-bold py-2 px-4 rounded hover:bg-green-600 transition-colors mb-4 inline-block">Add Product</a>
        ...
        <tr id="product-row-<?= $product['id'] ?>">
            ...
            <td class="px-6 py-4 whitespace-nowrap">
                <?php if (!empty($product['image'])): ?>
                    <img src="<?= $imageBaseUrl . urlencode(basename($product['image'])) ?>" alt="<?= htmlspecialchars($product['name']) ?>" class="h-40 w-40 object-cover object-center rounded-lg">                <?php else: ?>
                    No Image
                <?php endif; ?>
            </td>
